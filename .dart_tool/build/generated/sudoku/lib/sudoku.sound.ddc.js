define(['dart_sdk'], (function load__packages__sudoku__sudoku(dart_sdk) {
  ...
  var T = {
    ...
    MapOfDimension$SetOfint: () => (T.MapOfDimension$SetOfint = dart.constFn(core.Map$(sudoku.Dimension, T.SetOfint())))(),
    IdentityMapOfint$MapOfDimension$SetOfint: () => (T.IdentityMapOfint$MapOfDimension$SetOfint = dart.constFn(_js_helper.IdentityMap$(core.int, T.MapOfDimension$SetOfint())))(),
    MapOfint$SetOfint: () => (T.MapOfint$SetOfint = dart.constFn(core.Map$(core.int, T.SetOfint())))(),
    MapOfDimension$MapOfint$SetOfint: () => (T.MapOfDimension$MapOfint$SetOfint = dart.constFn(core.Map$(sudoku.Dimension, T.MapOfint$SetOfint())))(),
    IdentityMapOfint$MapOfDimension$MapOfint$SetOfint: () => (T.IdentityMapOfint$MapOfDimension$MapOfint$SetOfint = dart.constFn(_js_helper.IdentityMap$(core.int, T.MapOfDimension$MapOfint$SetOfint())))(),
    ...
    DimensionTobool: () => (T.DimensionTobool = dart.constFn(dart.fnType(core.bool, [sudoku.Dimension])))(),
    ...
    intAndintAndintTobool: () => (T.intAndintAndintTobool = dart.constFn(dart.fnType(core.bool, [core.int, core.int, core.int])))(),
    LinkedMapOfDimension$SetOfint: () => (T.LinkedMapOfDimension$SetOfint = dart.constFn(_js_helper.LinkedMap$(sudoku.Dimension, T.SetOfint())))(),
    VoidToMapOfDimension$SetOfint: () => (T.VoidToMapOfDimension$SetOfint = dart.constFn(dart.fnType(T.MapOfDimension$SetOfint(), [])))(),
    VoidToSetOfint: () => (T.VoidToSetOfint = dart.constFn(dart.fnType(T.SetOfint(), [])))(),
    DimensionAndSetOfintTobool: () => (T.DimensionAndSetOfintTobool = dart.constFn(dart.fnType(core.bool, [sudoku.Dimension, T.SetOfint()])))(),
    intAndMapOfDimension$SetOfintTobool: () => (T.intAndMapOfDimension$SetOfintTobool = dart.constFn(dart.fnType(core.bool, [core.int, T.MapOfDimension$SetOfint()])))(),
    LinkedMapOfDimension$MapOfint$SetOfint: () => (T.LinkedMapOfDimension$MapOfint$SetOfint = dart.constFn(_js_helper.LinkedMap$(sudoku.Dimension, T.MapOfint$SetOfint())))(),
    VoidToMapOfDimension$MapOfint$SetOfint: () => (T.VoidToMapOfDimension$MapOfint$SetOfint = dart.constFn(dart.fnType(T.MapOfDimension$MapOfint$SetOfint(), [])))(),
    IdentityMapOfint$SetOfint: () => (T.IdentityMapOfint$SetOfint = dart.constFn(_js_helper.IdentityMap$(core.int, T.SetOfint())))(),
    VoidToMapOfint$SetOfint: () => (T.VoidToMapOfint$SetOfint = dart.constFn(dart.fnType(T.MapOfint$SetOfint(), [])))(),
    MapOfint$MapOfDimension$MapOfint$SetOfint: () => (T.MapOfint$MapOfDimension$MapOfint$SetOfint = dart.constFn(core.Map$(core.int, T.MapOfDimension$MapOfint$SetOfint())))(),
    VoidToMapOfint$MapOfDimension$MapOfint$SetOfint: () => (T.VoidToMapOfint$MapOfDimension$MapOfint$SetOfint = dart.constFn(dart.fnType(T.MapOfint$MapOfDimension$MapOfint$SetOfint(), [])))(),
    SetOfintTobool: () => (T.SetOfintTobool = dart.constFn(dart.fnType(core.bool, [T.SetOfint()])))(),
    ...
    DimensionAndFnToNull: () => (T.DimensionAndFnToNull = dart.constFn(dart.fnType(core.Null, [sudoku.Dimension, T.intAndFnTodynamic()])))(),
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        __proto__: sudoku.Dimension.prototype,
        [_Enum__name]: "y",
        [_Enum_index]: 1
      });
    },
    ...
    get C3() {
      return C[3] = dart.constList([C[2] || CT.C2, C[0] || CT.C0, C[1] || CT.C1], sudoku.Dimension);
    },
    get C5() {
    ...
    get C4() {
      return C[4] = dart.constList([C[5] || CT.C5, C[6] || CT.C6, C[7] || CT.C7, C[8] || CT.C8], sudoku.Move);
    },
    get C10() {
    ...
    get C9() {
      return C[9] = dart.constList([C[10] || CT.C10, C[11] || CT.C11, C[12] || CT.C12, C[13] || CT.C13], sudoku.Mode);
    },
    get C15() {
    ...
    get C14() {
      return C[14] = dart.constList([C[15] || CT.C15, C[16] || CT.C16, C[17] || CT.C17, C[18] || CT.C18, C[19] || CT.C19], sudoku.Finding);
    },
    get C20() {
      return C[20] = dart.fn(sudoku.scanColumn, T.intAndintAndFnTovoid());
    },
    get C21() {
      return C[21] = dart.fn(sudoku.scanRow, T.intAndintAndFnTovoid());
    },
    get C22() {
      return C[22] = dart.fn(sudoku.scanBox, T.intAndintAndFnTovoid());
    },
    get C23() {
      return C[23] = dart.fn(sudoku.scanXsForY, T.intAndFnTovoid());
    },
    get C24() {
      return C[24] = dart.fn(sudoku.scanYsForX, T.intAndFnTovoid());
    },
    get C25() {
      return C[25] = dart.fn(sudoku.scanYXsForBox, T.intAndFnTovoid());
    },
    get C26() {
      return C[26] = dart.constMap(core.int, core.String, [1, "one", 2, "two", 3, "three", 4, "four", 5, "five", 6, "six", 7, "seven", 8, "eight", 9, "nine"]);
    },
    get C28() {
      return C[28] = dart.constList(["600090007", "040007100", "002800050", "800000090", "000070000", "030000008", "050002300", "004500020", "900030004"], core.String);
    },
    get C27() {
      return C[27] = dart.constList([C[28] || CT.C28], T.ListOfString());
    },
    get C30() {
      return C[30] = dart.constList(["086010047", "001500000", "000000002", "060000500", "000040200", "700900064", "070050081", "000000600", "900003000"], core.String);
    },
    get C31() {
      return C[31] = dart.constList(["049002000", "000007000", "260000950", "034070000", "600205001", "000060890", "082000046", "000800000", "000300510"], core.String);
    },
    get C32() {
      return C[32] = dart.constList(["000700100", "007006830", "000300056", "000070010", "400902005", "010060000", "270001000", "069800200", "005007000"], core.String);
    },
    get C33() {
      return C[33] = dart.constList(["900001005", "600000140", "000058000", "500704000", "090080030", "000306008", "000460000", "024000009", "300100007"], core.String);
    },
    get C29() {
      return C[29] = dart.constList([C[30] || CT.C30, C[31] || CT.C31, C[32] || CT.C32, C[33] || CT.C33], T.ListOfString());
    },
    get C35() {
      return C[35] = dart.constList(["000046500", "000000900", "006003020", "003080000", "000409080", "090000060", "700090005", "240810000", "050030000"], core.String);
    },
    get C34() {
      return C[34] = dart.constList([C[35] || CT.C35], T.ListOfString());
    },
    get C37() {
      return C[37] = dart.constList(["000076003", "000080000", "730000010", "092000400", "007068000", "000040070", "000000000", "000257306", "400000058"], core.String);
    },
    get C36() {
      return C[36] = dart.constList([C[37] || CT.C37], T.ListOfString());
    },
    get C39() {
      return C[39] = dart.constList(["003020600", "900305001", "001806400", "008102900", "700000008", "006708200", "002609500", "800203009", "005010300"], core.String);
    },
    get C40() {
      return C[40] = dart.constList(["200080300", "060070084", "030500209", "000105408", "000000000", "402706000", "301007040", "720040060", "004010003"], core.String);
    },
    get C41() {
      return C[41] = dart.constList(["000000907", "000420180", "000705026", "100904000", "050000040", "000507009", "920108000", "034059000", "507000000"], core.String);
    },
    get C42() {
      return C[42] = dart.constList(["030050040", "008010500", "460000012", "070502080", "000603000", "040109030", "250000098", "001020600", "080060020"], core.String);
    },
    get C43() {
      return C[43] = dart.constList(["020810740", "700003100", "090002805", "009040087", "400208003", "160030200", "302700060", "005600008", "076051090"], core.String);
    },
    get C44() {
      return C[44] = dart.constList(["100920000", "524010000", "000000070", "050008102", "000000000", "402700090", "060000000", "000030945", "000071006"], core.String);
    },
    get C45() {
      return C[45] = dart.constList(["043080250", "600000000", "000001094", "900004070", "000608000", "010200003", "820500000", "000000005", "034090710"], core.String);
    },
    get C46() {
      return C[46] = dart.constList(["480006902", "002008001", "900370060", "840010200", "003704100", "001060049", "020085007", "700900600", "609200018"], core.String);
    },
    get C47() {
      return C[47] = dart.constList(["000900002", "050123400", "030000160", "908000000", "070000090", "000000205", "091000050", "007439020", "400007000"], core.String);
    },
    get C48() {
      return C[48] = dart.constList(["001900003", "900700160", "030005007", "050000009", "004302600", "200000070", "600100030", "042007006", "500006800"], core.String);
    },
    get C49() {
      return C[49] = dart.constList(["000125400", "008400000", "420800000", "030000095", "060902010", "510000060", "000003049", "000007200", "001298000"], core.String);
    },
    get C50() {
      return C[50] = dart.constList(["062340750", "100005600", "570000040", "000094800", "400000006", "005830000", "030000091", "006400007", "059083260"], core.String);
    },
    get C51() {
      return C[51] = dart.constList(["300000000", "005009000", "200504000", "020000700", "160000058", "704310600", "000890100", "000067080", "000005437"], core.String);
    },
    get C52() {
      return C[52] = dart.constList(["630000000", "000500008", "005674000", "000020000", "003401020", "000000345", "000007004", "080300902", "947100080"], core.String);
    },
    get C53() {
      return C[53] = dart.constList(["000020040", "008035000", "000070602", "031046970", "200000000", "000501203", "049000730", "000000010", "800004000"], core.String);
    },
    get C54() {
      return C[54] = dart.constList(["361025900", "080960010", "400000057", "008000471", "000603000", "259000800", "740000005", "020018060", "005470329"], core.String);
    },
    get C55() {
      return C[55] = dart.constList(["050807020", "600010090", "702540006", "070020301", "504000908", "103080070", "900076205", "060090003", "080103040"], core.String);
    },
    get C56() {
      return C[56] = dart.constList(["080005000", "000003457", "000070809", "060400903", "007010500", "408007020", "901020000", "842300000", "000100080"], core.String);
    },
    get C57() {
      return C[57] = dart.constList(["003502900", "000040000", "106000305", "900251008", "070408030", "800763001", "308000104", "000020000", "005104800"], core.String);
    },
    get C58() {
      return C[58] = dart.constList(["000000000", "009805100", "051907420", "290401065", "000000000", "140508093", "026709580", "005103600", "000000000"], core.String);
    },
    get C59() {
      return C[59] = dart.constList(["020030090", "000907000", "900208005", "004806500", "607000208", "003102900", "800605007", "000309000", "030020050"], core.String);
    },
    get C60() {
      return C[60] = dart.constList(["005000006", "070009020", "000500107", "804150000", "000803000", "000092805", "907006000", "030400010", "200000600"], core.String);
    },
    get C61() {
      return C[61] = dart.constList(["040000050", "001943600", "009000300", "600050002", "103000506", "800020007", "005000200", "002436700", "030000040"], core.String);
    },
    get C62() {
      return C[62] = dart.constList(["004000000", "000030002", "390700080", "400009001", "209801307", "600200008", "010008053", "900040000", "000000800"], core.String);
    },
    get C63() {
      return C[63] = dart.constList(["360020089", "000361000", "000000000", "803000602", "400603007", "607000108", "000000000", "000418000", "970030014"], core.String);
    },
    get C64() {
      return C[64] = dart.constList(["500400060", "009000800", "640020000", "000001008", "208000501", "700500000", "000090084", "003000600", "060003002"], core.String);
    },
    get C65() {
      return C[65] = dart.constList(["007256400", "400000005", "010030060", "000508000", "008060200", "000107000", "030070090", "200000004", "006312700"], core.String);
    },
    get C66() {
      return C[66] = dart.constList(["000000000", "079050180", "800000007", "007306800", "450708096", "003502700", "700000005", "016030420", "000000000"], core.String);
    },
    get C67() {
      return C[67] = dart.constList(["030000080", "009000500", "007509200", "700105008", "020090030", "900402001", "004207100", "002000800", "070000090"], core.String);
    },
    get C68() {
      return C[68] = dart.constList(["200170603", "050000100", "000006079", "000040700", "000801000", "009050000", "310400000", "005000060", "906037002"], core.String);
    },
    get C69() {
      return C[69] = dart.constList(["000000080", "800701040", "040020030", "374000900", "000030000", "005000321", "010060050", "050802006", "080000000"], core.String);
    },
    get C70() {
      return C[70] = dart.constList(["000000085", "000210009", "960080100", "500800016", "000000000", "890006007", "009070052", "300054000", "480000000"], core.String);
    },
    get C71() {
      return C[71] = dart.constList(["608070502", "050608070", "002000300", "500090006", "040302050", "800050003", "005000200", "010704090", "409060701"], core.String);
    },
    get C72() {
      return C[72] = dart.constList(["050010040", "107000602", "000905000", "208030501", "040070020", "901080406", "000401000", "304000709", "020060010"], core.String);
    },
    get C73() {
      return C[73] = dart.constList(["053000790", "009753400", "100000002", "090080010", "000907000", "080030070", "500000003", "007641200", "061000940"], core.String);
    },
    get C74() {
      return C[74] = dart.constList(["006080300", "049070250", "000405000", "600317004", "007000800", "100826009", "000702000", "075040190", "003090600"], core.String);
    },
    get C75() {
      return C[75] = dart.constList(["005080700", "700204005", "320000084", "060105040", "008000500", "070803010", "450000091", "600508007", "003010600"], core.String);
    },
    get C76() {
      return C[76] = dart.constList(["000900800", "128006400", "070800060", "800430007", "500000009", "600079008", "090004010", "003600284", "001007000"], core.String);
    },
    get C77() {
      return C[77] = dart.constList(["000080000", "270000054", "095000810", "009806400", "020403060", "006905100", "017000620", "460000038", "000090000"], core.String);
    },
    get C78() {
      return C[78] = dart.constList(["000602000", "400050001", "085010620", "038206710", "000000000", "019407350", "026040530", "900020007", "000809000"], core.String);
    },
    get C79() {
      return C[79] = dart.constList(["380000000", "000400785", "009020300", "060090000", "800302009", "000040070", "001070500", "495006000", "000000092"], core.String);
    },
    get C80() {
      return C[80] = dart.constList(["000158000", "002060800", "030000040", "027030510", "000000000", "046080790", "050000080", "004070100", "000325000"], core.String);
    },
    get C81() {
      return C[81] = dart.constList(["010500200", "900001000", "002008030", "500030007", "008000500", "600080004", "040100700", "000700006", "003004050"], core.String);
    },
    get C82() {
      return C[82] = dart.constList(["080000040", "000469000", "400000007", "005904600", "070608030", "008502100", "900000005", "000781000", "060000010"], core.String);
    },
    get C83() {
      return C[83] = dart.constList(["904200007", "010000000", "000706500", "000800090", "020904060", "040002000", "001607000", "000000030", "300005702"], core.String);
    },
    get C84() {
      return C[84] = dart.constList(["000700800", "006000031", "040002000", "024070000", "010030080", "000060290", "000800070", "860000500", "002006000"], core.String);
    },
    get C85() {
      return C[85] = dart.constList(["001007090", "590080001", "030000080", "000005800", "050060020", "004100000", "080000030", "100020079", "020700400"], core.String);
    },
    get C86() {
      return C[86] = dart.constList(["000003017", "015009008", "060000000", "100007000", "009000200", "000500004", "000000020", "500600340", "340200000"], core.String);
    },
    get C87() {
      return C[87] = dart.constList(["300200000", "000107000", "706030500", "070009080", "900020004", "010800050", "009040301", "000702000", "000008006"], core.String);
    },
    get C38() {
      return C[38] = dart.constList([C[39] || CT.C39, C[40] || CT.C40, C[41] || CT.C41, C[42] || CT.C42, C[43] || CT.C43, C[44] || CT.C44, C[45] || CT.C45, C[46] || CT.C46, C[47] || CT.C47, C[48] || CT.C48, C[49] || CT.C49, C[50] || CT.C50, C[51] || CT.C51, C[52] || CT.C52, C[53] || CT.C53, C[54] || CT.C54, C[55] || CT.C55, C[56] || CT.C56, C[57] || CT.C57, C[58] || CT.C58, C[59] || CT.C59, C[60] || CT.C60, C[61] || CT.C61, C[62] || CT.C62, C[63] || CT.C63, C[64] || CT.C64, C[65] || CT.C65, C[66] || CT.C66, C[67] || CT.C67, C[68] || CT.C68, C[69] || CT.C69, C[70] || CT.C70, C[71] || CT.C71, C[72] || CT.C72, C[73] || CT.C73, C[74] || CT.C74, C[75] || CT.C75, C[76] || CT.C76, C[77] || CT.C77, C[78] || CT.C78, C[47] || CT.C47, C[79] || CT.C79, C[80] || CT.C80, C[81] || CT.C81, C[82] || CT.C82, C[83] || CT.C83, C[84] || CT.C84, C[85] || CT.C85, C[86] || CT.C86, C[87] || CT.C87], T.ListOfString());
    },
    get C88() {
      return C[88] = dart.constSet(core.int, [1, 2, 3, 4, 5, 6, 7, 8, 9]);
    },
    get C90() {
      return C[90] = dart.constList([0, 0], core.int);
    },
    get C91() {
      return C[91] = dart.constList([0, 3], core.int);
    },
    get C92() {
      return C[92] = dart.constList([0, 6], core.int);
    },
    get C93() {
      return C[93] = dart.constList([3, 0], core.int);
    },
    get C94() {
      return C[94] = dart.constList([3, 3], core.int);
    },
    get C95() {
      return C[95] = dart.constList([3, 6], core.int);
    },
    get C96() {
      return C[96] = dart.constList([6, 0], core.int);
    },
    get C97() {
      return C[97] = dart.constList([6, 3], core.int);
    },
    get C98() {
      return C[98] = dart.constList([6, 6], core.int);
    },
    get C89() {
      return C[89] = dart.constList([C[90] || CT.C90, C[91] || CT.C91, C[92] || CT.C92, C[93] || CT.C93, C[94] || CT.C94, C[95] || CT.C95, C[96] || CT.C96, C[97] || CT.C97, C[98] || CT.C98], T.ListOfint());
    }
  }, false);
  ...
  var _info = dart.privateName(sudoku, "_info");
  var _counts = dart.privateName(sudoku, "_counts");
  ...
  sudoku.Game = class Game extends core.Object {
    ...
    get candidates() {
      return sudoku['CandidateX|copy'](this[_candidates], {withMerge: this[_userCandidates][$last]});
    }
    get [_puzzle]() {
      let t0;
    ...
    oneOfTwo(y, x, value) {
      let t0;
      return (t0 = this[_counts][$_get](value), t0 == null ? null : t0[$keys][$any](dart.fn(dimension => dart.nullCheck(dart.nullCheck(this[_counts][$_get](value))[$_get](dimension))[$keys][$any](dart.fn(key => {
        let t1, t1$, t2, t1$0;
        switch (dimension) {
          case C[0] || CT.C0:
            {
              return (t1 = dart.nullCheck(dart.nullCheck(this[_counts][$_get](value))[$_get](dimension))[$_get](y), t1 == null ? null : t1[$length]) === 2;
            }
          case C[1] || CT.C1:
            {
              return (t1$ = dart.nullCheck(dart.nullCheck(this[_counts][$_get](value))[$_get](dimension))[$_get](x), t1$ == null ? null : t1$[$length]) === 2;
            }
          case C[2] || CT.C2:
            {
              return (t1$0 = dart.nullCheck(this[_counts][$_get](value))[$_get](dimension), t1$0 == null ? null : (t2 = t1$0[$_get](sudoku.getBox(y, x)), t2 == null ? null : t2[$length])) === 2;
            }
        }
      }, T.intTobool())), T.DimensionTobool()))) === true;
    }
    related(y, x) {
      return this[_selectedValue] != null && sudoku['_extension#0|possible'](this[_info], y, x, dart.nullCheck(this[_selectedValue])) && this[_puzzle][$_get](y)[$_get](x) == null && this[_entries][$last][$_get](y)[$_get](x) == null;
    }
    get hasCursor() {
    ...
    [_initPuzzle]() {
      ...
      this[_info] = new (T.IdentityMapOfint$MapOfDimension$SetOfint()).new();
      this[_counts] = new (T.IdentityMapOfint$MapOfDimension$MapOfint$SetOfint()).new();
      this[_redraw]();
    }
    [_handleRewind]() {
    ...
    [_handleCursor](cursorInput) {
      ...
      if (this.hasCursor) {
        core.print("Cursor Values -------------------");
        let vals = T.JSArrayOfString().of([]);
        for (let value of sudoku.possibleValues) {
          if ((t0 = this[_counts][$_get](value), t0 == null ? null : (t1 = t0[$_get](sudoku.Dimension.y), t1 == null ? null : (t2 = t1[$_get](this[_cursorY]), t2 == null ? null : t2[$isNotEmpty]))) === true) {
            vals[$add](value[$toString]());
          } else {
            vals[$add](" ");
          }
        }
        core.print("  col values: " + vals[$join](" "));
        vals[$clear]();
        for (let value of sudoku.possibleValues) {
          if ((t0$ = this[_counts][$_get](value), t0$ == null ? null : (t1$ = t0$[$_get](sudoku.Dimension.x), t1$ == null ? null : (t2$ = t1$[$_get](this[_cursorX]), t2$ == null ? null : t2$[$isNotEmpty]))) === true) {
            vals[$add](value[$toString]());
          } else {
            vals[$add](" ");
          }
        }
        core.print("  row values: " + vals[$join](" "));
        vals[$clear]();
        let b = sudoku.getBox(this[_cursorY], this[_cursorX]);
        for (let value of sudoku.possibleValues) {
          if ((t0$0 = this[_counts][$_get](value), t0$0 == null ? null : (t1$0 = t0$0[$_get](sudoku.Dimension.b), t1$0 == null ? null : (t2$0 = t1$0[$_get](b), t2$0 == null ? null : t2$0[$isNotEmpty]))) === true) {
            vals[$add](value[$toString]());
          } else {
            vals[$add](" ");
          }
        }
        core.print("  box values: " + vals[$join](" "));
      }
    ...
    [_handleToggle](toggleInput) {
      ...
      if (this.hasCursor) {
        ...
        if (this[_mode] !== sudoku.Mode.note) this[_select](toggleInput.value);
        this[_calc]();
      }
    }
    [_select](value) {
    ...
    [_calc]() {
      let v = this.values;
      this[_candidates] = sudoku.calcCandidates(v);
      let c = this.candidates;
      this[_info] = sudoku.calcInfo(v);
      this[_counts] = sudoku.calcCounts(v, this[_info]);
      if (this[_mode] !== sudoku.Mode.puzzle) {
        this[_findings] = sudoku.calcFindings(v, c, this[_info], this[_counts]);
      }
      this[_invalids] = sudoku.calcInvalids(v, c);
    }
  };
  ...
  dart.setMethodSignature(sudoku.Game, () => ({
    ...
    oneOfTwo: dart.fnType(core.bool, [core.int, core.int, core.int]),
  ...
  dart.setFieldSignature(sudoku.Game, () => ({
    ...
    [_info]: dart.fieldType(core.Map$(core.int, core.Map$(sudoku.Dimension, core.Set$(core.int)))),
    [_counts]: dart.fieldType(core.Map$(core.int, core.Map$(sudoku.Dimension, core.Map$(core.int, core.Set$(core.int)))))
  }));
  ...
  sudoku.Renderer = class Renderer extends core.Object {
    ...
    [_tileInnerHtml](y, x, value, candidates) {
      if (value != null) {
        ...
        let candidateHtml = "";
        for (let value of sudoku.possibleValues) {
          let contents = findings[$containsKey](value) || this[_game].candidates[$_get](y)[$_get](x).contains(value) ? dart.str(value) : "";
          candidateHtml = candidateHtml + ("<div class=\"" + this[_candidateClassName](value, selectedValue, findings, this[_game].oneOfTwo(y, x, value)) + "\">" + contents + "</div>");
        }
        return candidateHtml;
      }
    }
    [_candidateClassName](value, selectedValue, findings, oneOfTwo) {
  ...
  dart.setMethodSignature(sudoku.Renderer, () => ({
    ...
    [_candidateClassName]: dart.fnType(core.String, [core.int, dart.nullable(core.int), core.Map$(core.int, sudoku.Finding), core.bool]),
  ...
  sudoku.Dimension = class Dimension extends core._Enum {
    toString() {
      return "Dimension." + this[_name];
    }
  };
  (sudoku.Dimension.new = function(index, name) {
    sudoku.Dimension.__proto__.new.call(this, index, name);
    ;
  }).prototype = sudoku.Dimension.prototype;
  dart.addTypeTests(sudoku.Dimension);
  dart.addTypeCaches(sudoku.Dimension);
  dart.setLibraryUri(sudoku.Dimension, I[0]);
  dart.setStaticFieldSignature(sudoku.Dimension, () => ['values', 'b', 'y', 'x']);
  dart.defineExtensionMethods(sudoku.Dimension, ['toString']);
  dart.defineLazy(sudoku.Dimension, {
    /*sudoku.Dimension.values*/get values() {
      return C[3] || CT.C3;
    },
    /*sudoku.Dimension.b*/get b() {
      return C[2] || CT.C2;
    },
    /*sudoku.Dimension.y*/get y() {
      return C[0] || CT.C0;
    },
    /*sudoku.Dimension.x*/get x() {
      return C[1] || CT.C1;
    }
  }, false);
  ...
  dart.setStaticFieldSignature(sudoku.Finding, () => ['values', 'lastStanding', 'forcedOut', 'neededElsewhere', 'xwing', 'note']);
  ...
  dart.defineLazy(sudoku.Finding, {
    ...
    /*sudoku.Finding.xwing*/get xwing() {
      return C[18] || CT.C18;
    },
  ...
  sudoku['CandidateX|copy'] = function CandidateX$124copy($this, opts) {
    ...
    if (withMerge != null) {
      ...
      sudoku.scan(dart.fn((y, x) => {
        let t14, t13, t12;
        t12 = candidates[$_get](y);
        t13 = x;
        t14 = $this[$_get](y)[$_get](x).toSet();
        t12[$_set](t13, t14);
        return t14;
  ...
  sudoku.calcInvalids = function calcInvalids(values, candidates) {
    ...
    sudoku.scan(dart.fn((y, x) => {
      ...
      if (value == null) {
        ...
        validateDimention(C[20] || CT.C20);
        validateDimention(C[21] || CT.C21);
        validateDimention(C[22] || CT.C22);
        if (valueCount > 1) {
          invalid[$putIfAbsent](y, dart.fn(() => new (T.IdentityMapOfint$bool()).new(), T.VoidToMapOfint$bool()));
          dart.nullCheck(invalid[$_get](y))[$_set](x, true);
        }
  ...
  sudoku['_extension#0|possible'] = function _extension$350$124possible($this, y, x, value) {
    let t24, t23, t24$, t23$, t24$0, t23$0;
    return (t23 = $this[$_get](value), t23 == null ? null : (t24 = t23[$_get](sudoku.Dimension.y), t24 == null ? null : t24.contains(y))) === true && (t23$ = $this[$_get](value), t23$ == null ? null : (t24$ = t23$[$_get](sudoku.Dimension.x), t24$ == null ? null : t24$.contains(x))) === true && (t23$0 = $this[$_get](value), t23$0 == null ? null : (t24$0 = t23$0[$_get](sudoku.Dimension.b), t24$0 == null ? null : t24$0.contains(sudoku.getBox(y, x)))) === true;
  };
  sudoku['_extension#0|get#possible'] = function _extension$350$124get$35possible($this) {
    return dart.fn((y, x, value) => sudoku['_extension#0|possible']($this, y, x, value), T.intAndintAndintTobool());
  };
  sudoku.calcInfo = function calcInfo(values) {
    let info = new (T.IdentityMapOfint$MapOfDimension$SetOfint()).new();
    sudoku.scan(dart.fn((y, x) => {
      let value = values[$_get](y)[$_get](x);
      if (value != null) {
        info[$putIfAbsent](value, dart.fn(() => new (T.LinkedMapOfDimension$SetOfint()).new(), T.VoidToMapOfDimension$SetOfint()));
        dart.nullCheck(info[$_get](value))[$putIfAbsent](sudoku.Dimension.y, dart.fn(() => (() => {
          let t24 = T.LinkedHashSetOfint().new();
          for (let t26 of T.ListOfint().generate(9, dart.fn(i => i, T.intToint()))) {
            let t25 = core.int.as(t26);
            t24.add(t25);
          }
          return t24;
        })(), T.VoidToSetOfint()));
        dart.nullCheck(info[$_get](value))[$putIfAbsent](sudoku.Dimension.x, dart.fn(() => (() => {
          let t27 = T.LinkedHashSetOfint().new();
          for (let t29 of T.ListOfint().generate(9, dart.fn(i => i, T.intToint()))) {
            let t28 = core.int.as(t29);
            t27.add(t28);
          }
          return t27;
        })(), T.VoidToSetOfint()));
        dart.nullCheck(info[$_get](value))[$putIfAbsent](sudoku.Dimension.b, dart.fn(() => (() => {
          let t30 = T.LinkedHashSetOfint().new();
          for (let t32 of T.ListOfint().generate(9, dart.fn(i => i, T.intToint()))) {
            let t31 = core.int.as(t32);
            t30.add(t31);
          }
          return t30;
        })(), T.VoidToSetOfint()));
        dart.nullCheck(dart.nullCheck(info[$_get](value))[$_get](sudoku.Dimension.y)).remove(y);
        dart.nullCheck(dart.nullCheck(info[$_get](value))[$_get](sudoku.Dimension.x)).remove(x);
        dart.nullCheck(dart.nullCheck(info[$_get](value))[$_get](sudoku.Dimension.b)).remove(dart.nullCheck(sudoku.getBox(y, x)));
      }
    }, T.intAndintToNull()));
    for (let value of info[$keys]) {
      dart.nullCheck(info[$_get](value))[$removeWhere](dart.fn((_, remaining) => remaining[$isEmpty], T.DimensionAndSetOfintTobool()));
    }
    info[$removeWhere](dart.fn((_, dimensions) => dimensions[$isEmpty], T.intAndMapOfDimension$SetOfintTobool()));
    return info;
  };
  sudoku.calcCounts = function calcCounts(values, info) {
    let counts = new (T.IdentityMapOfint$MapOfDimension$MapOfint$SetOfint()).new();
    for (let value of info[$keys]) {
      for (let dimension of dart.nullCheck(info[$_get](value))[$keys]) {
        for (let i of dart.nullCheck(dart.nullCheck(info[$_get](value))[$_get](dimension))) {
          let j = 0;
          sudoku.iteratorForDimension(dimension)(i, dart.fn((y, x) => {
            if (values[$_get](y)[$_get](x) == null && sudoku['_extension#0|possible'](info, y, x, value)) {
              counts[$putIfAbsent](value, dart.fn(() => new (T.LinkedMapOfDimension$MapOfint$SetOfint()).new(), T.VoidToMapOfDimension$MapOfint$SetOfint()));
              dart.nullCheck(counts[$_get](value))[$putIfAbsent](dimension, dart.fn(() => new (T.IdentityMapOfint$SetOfint()).new(), T.VoidToMapOfint$SetOfint()));
              dart.nullCheck(dart.nullCheck(counts[$_get](value))[$_get](dimension))[$putIfAbsent](i, dart.fn(() => T.LinkedHashSetOfint().new(), T.VoidToSetOfint()));
              dart.nullCheck(dart.nullCheck(dart.nullCheck(counts[$_get](value))[$_get](dimension))[$_get](i)).add(j);
            }
            j = j + 1;
          }, T.intAndintToNull()));
        }
  ...
  sudoku['_extension#1|get#onlyPairs'] = function _extension$351$124get$35onlyPairs($this) {
    return dart.fn(() => sudoku['_extension#1|onlyPairs']($this), T.VoidToMapOfint$MapOfDimension$MapOfint$SetOfint());
  };
  sudoku['_extension#1|onlyPairs'] = function _extension$351$124onlyPairs($this) {
    let counts = new (T.IdentityMapOfint$MapOfDimension$MapOfint$SetOfint()).new();
    for (let value of $this[$keys]) {
      for (let dimension of dart.nullCheck($this[$_get](value))[$keys]) {
        for (let i of dart.nullCheck(dart.nullCheck($this[$_get](value))[$_get](dimension))[$keys]) {
          if (dart.nullCheck(dart.nullCheck(dart.nullCheck($this[$_get](value))[$_get](dimension))[$_get](i))[$length] === 2) {
            counts[$putIfAbsent](value, dart.fn(() => new (T.LinkedMapOfDimension$MapOfint$SetOfint()).new(), T.VoidToMapOfDimension$MapOfint$SetOfint()));
            dart.nullCheck(counts[$_get](value))[$putIfAbsent](dimension, dart.fn(() => new (T.IdentityMapOfint$SetOfint()).new(), T.VoidToMapOfint$SetOfint()));
            dart.nullCheck(dart.nullCheck(counts[$_get](value))[$_get](dimension))[$_set](i, dart.nullCheck(dart.nullCheck(dart.nullCheck($this[$_get](value))[$_get](dimension))[$_get](i)).toSet());
          }
        }
      }
    }
  ...
  sudoku['_extension#2|same'] = function _extension$352$124same($this, other) {
    return $this[$first] === other[$first] && $this[$last] === other[$last] || $this[$first] === other[$last] && $this[$last] === other[$first];
  };
  sudoku['_extension#2|get#same'] = function _extension$352$124get$35same($this) {
    return dart.fn(other => sudoku['_extension#2|same']($this, other), T.SetOfintTobool());
  };
  sudoku.calcCandidates = function calcCandidates(values) {
  ...
  sudoku.calcFindings = function calcFindings(values, candidates, info, counts) {
    ...
    if (findings[$isEmpty]) {
      sudoku['FindingsX|addOther'](findings, sudoku.findXWingCandidates(values, candidates, info, counts));
    }
    if (findings[$isEmpty]) {
  ...
  sudoku.findXWingCandidates = function findXWingCandidates(values, candidates, info, counts) {
    let findings = new (T.IdentityMapOfint$MapOfint$MapOfint$Finding()).new();
    let pairs = sudoku['_extension#1|onlyPairs'](counts);
    function findCrossAxisXwings(dimension, crossAxisIterator) {
      for (let value of pairs[$keys]) {
        if (dart.nullCheck(pairs[$_get](value))[$_get](dimension) == null) return;
        let added = T.LinkedHashSetOfint().new();
        for (let i1 of dart.nullCheck(dart.nullCheck(pairs[$_get](value))[$_get](dimension))[$keys]) {
          let jPair = dart.nullCheck(dart.nullCheck(dart.nullCheck(pairs[$_get](value))[$_get](dimension))[$_get](i1));
          for (let i2 of dart.nullCheck(dart.nullCheck(pairs[$_get](value))[$_get](dimension))[$keys]) {
            if (i1 !== i2 && !added.contains(i1) && !added.contains(i2) && sudoku['_extension#2|same'](jPair, dart.nullCheck(dart.nullCheck(dart.nullCheck(pairs[$_get](value))[$_get](dimension))[$_get](i2)))) {
              function scanForPair(x, y) {
                let excludeYs = dimension === sudoku.Dimension.y ? T.LinkedHashSetOfint().from([i1, i2]) : T.LinkedHashSetOfint().new();
                let excludeXs = dimension === sudoku.Dimension.y ? T.LinkedHashSetOfint().new() : T.LinkedHashSetOfint().from([i1, i2]);
                ...
                if (values[$_get](y)[$_get](x) == null && candidates[$_get](y)[$_get](x).contains(value)) {
                  ...
                  dart.nullCheck(dart.nullCheck(findings[$_get](y))[$_get](x))[$_set](value, sudoku.Finding.xwing);
                }
              }
              dart.fn(scanForPair, T.intAndintToNull());
    ...
    dart.fn(findCrossAxisXwings, T.DimensionAndFnToNull());
    findCrossAxisXwings(sudoku.Dimension.y, C[23] || CT.C23);
    findCrossAxisXwings(sudoku.Dimension.x, C[24] || CT.C24);
    return findings;
  };
  sudoku.findNeededElsewhereCandidates = function findNeededElsewhereCandidates(values, candidates) {
    ...
    for (let setSize = 2; setSize < 9; setSize = setSize + 1) {
      sudoku.scanLine(dart.fn(i => {
        function checkForNeededElsewhere(ithIterator) {
          ...
          ithIterator(i, dart.fn((y, x) => {
            ...
            if (values[$_get](y)[$_get](x) == null && candidates[$_get](y)[$_get](x)[$length] === setSize) {
              ...
              setCounts[$_set](setKey, dart.notNull((t37 = setCounts[$_get](setKey), t37 == null ? 0 : t37)) + 1);
        ...
        checkForNeededElsewhere(C[24] || CT.C24);
        checkForNeededElsewhere(C[23] || CT.C23);
        checkForNeededElsewhere(C[25] || CT.C25);
      }, T.intToNull()));
    }
    return findings;
  };
  sudoku.findForcedOutCandidates = function findForcedOutCandidates(values, candidates) {
    ...
    sudoku.scanLine(dart.fn(i => {
      ...
      sudoku.scanYXsForBox(i, dart.fn((iy, ix) => {
        scanYs.add(iy);
        scanXs.add(ix);
  ...
  sudoku.findLastStandingValues = function findLastStandingValues(values, candidates) {
    ...
    sudoku.scan(dart.fn((y, x) => {
      ...
      if (candidates[$_get](y)[$_get](x)[$length] === 1) {
        ...
        checkForLastStanding(C[20] || CT.C20);
        checkForLastStanding(C[21] || CT.C21);
        checkForLastStanding(C[22] || CT.C22);
      }
    }, T.intAndintToNull()));
    return findings;
  };
  ...
  sudoku.scanYsForX = function scanYsForX(i, handler) {
    return sudoku.scanLine(dart.fn(j => handler(j, i), T.intTodynamic()));
  };
  sudoku.scanXsForY = function scanXsForY(i, handler) {
    return sudoku.scanLine(dart.fn(j => handler(i, j), T.intTodynamic()));
  };
  sudoku.scanYXsForBox = function scanYXsForBox(i, handler) {
    return sudoku.scanBox(sudoku._boxOrigins[$_get](i)[$_get](0), sudoku._boxOrigins[$_get](i)[$_get](1), handler);
  };
  sudoku.iteratorForDimension = function iteratorForDimension(dimension) {
    switch (dimension) {
      case C[2] || CT.C2:
        {
          return C[25] || CT.C25;
