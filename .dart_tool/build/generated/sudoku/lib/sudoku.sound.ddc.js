define(['dart_sdk'], (function load__packages__sudoku__sudoku(dart_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C21() {
      return C[21] = dart.constList(["900001005", "600000140", "000058000", "500704000", "090080030", "000306008", "000460000", "024000009", "300100007"], core.String);
    },
    get C22() {
    ...
    get C23() {
      return C[23] = dart.constList(["049002000", "000007000", "260000950", "034070000", "600205001", "000060890", "082000046", "000800000", "000300510"], core.String);
    },
    get C20() {
  ...
  sudoku.Game = class Game extends core.Object {
    ...
    [_loadNextPuzzle]() {
      ...
      this[_initPuzzle]();
      sudoku.parsedPuzzle(this[_parsePuzzleIndex], sudoku.easyPuzzles)[$forEach](dart.bind(this, _handleInput));
  ...
  sudoku.scanIthBox = function scanIthBox(i, handler) {
    return sudoku.scanLine(dart.fn(i => handler(sudoku._boxOrigins[$_get](i)[$_get](0), sudoku._boxOrigins[$_get](i)[$_get](1)), T.intTodynamic()));
  };
